Public Class ClsChallan24QObj
    ...
    Public Function Delete(ByVal ID As Long) As Boolean
        ...
        Dim sql As String
        sql = "Delete * From Challan24Q Where ChallanID = " & ID
    ...
    Public Function Update(ByVal Challan As ClsChallan24QObj) As Boolean
        ...
        End If
        With Challan
            sql = "Update Challan24Q Set RetnId = " & IIf(.RetnID = 0, 0, .RetnID) & "," _
    ...
    Public Function Insert(ByVal Challan As ClsChallan24QObj) As Boolean
        Dim sql As String, cnl As Boolean
        Dim cmd As New OleDb.OleDbCommand
        Dim transaction As OleDb.OleDbTransaction
        ...
        With Challan
            ...
            sql = " Insert Into Challan24Q (ChallanId,RetnId,Sec,TaxAmt, Surcharge, Ecess, Interest, Others, "
...
Err:
    ...
    Public Function MaxID() As Long
        ...
        Dim sql As String
        sql = "Select Max(ChallanId) as ID From Challan24Q"
    ...
    Public Function LinkDed24Q(ByVal ID As Long) As Boolean
        Dim nds As New DataSet
        Dim sql As String
        sql = "Select ChallanID  From Deductee24Q Where ChallanID = " & ID
        nds = FetchDataSet(sql)
    ...
    Private Sub ClsChallan24QObj_PrepareDataForSave(Cancel As Boolean) Handles Me.PrepareDataForSave
