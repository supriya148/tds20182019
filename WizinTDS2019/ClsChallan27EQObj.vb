Public Class ClsChallan27EQObj
    ...
    Public Function Delete(ByVal ID As Long) As Boolean
        ...
        Dim sql As String
        sql = "Delete * From Challan27EQ Where ChallanID = " & ID
    ...
    Public Function Update(ByVal Challan As ClsChallan27EQObj) As Boolean
        ...
        End If
        With Challan
            sql = "Update Challan27EQ Set RetnId = " & IIf(.RetnID = 0, 0, .RetnID) & "," _
    ...
    Public Function Insert(ByVal Challan As ClsChallan27EQObj) As Boolean
        Dim sql As String, cnl As Boolean
        Dim cmd As New OleDb.OleDbCommand
        Dim transaction As OleDb.OleDbTransaction
        ...
        With Challan
            ...
            sql = " Insert Into Challan27EQ (ChallanId,RetnId,Sec,TaxAmt, Surcharge, Ecess, Interest, Others, "
...
Err:
    ...
    Public Function MaxID() As Long
        ...
        Dim sql As String
        sql = "Select Max(ChallanId) as ID From Challan27EQ"
    ...
    Public Function LinkDed27EQ(ByVal ID As Long) As Boolean
        Dim nds As New DataSet
        Dim sql As String
        sql = "Select ChallanID  From Deductee27EQ Where ChallanID = " & ID
        nds = FetchDataSet(sql)
    ...
    Private Sub ClsChallan27EQObj_PrepareDataForSave(Cancel As Boolean) Handles Me.PrepareDataForSave
