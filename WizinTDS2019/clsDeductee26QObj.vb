Public Class clsDeductee26QObj
    'local variable(s) to hold property value(s)
    Private mvarID26Q As Long 'local copy
    ...
    Public Function Update(ByVal Deductee As clsDeductee26QObj) As Boolean
        ...
        End If
        With Deductee
            sql = "Update Deductee26Q Set RetnId = " & IIf(.RetnID = 0, 0, .RetnID) & "," _
    ...
    Public Function MaxID() As Long
        ...
        Dim sql As String
        sql = "Select Max(Id26Q) as Id From Deductee26Q"
    ...
    Public Function Insert(ByVal Deductee As clsDeductee26QObj) As Boolean
        Dim sql As String, cnl As Boolean
        Dim cmd As New OleDb.OleDbCommand
        Dim transaction As OleDb.OleDbTransaction
        ...
        With Deductee
            ...
            .ID26Q = MaxID() + 1
            sql = "Insert Into Deductee26Q (Id26Q,RetnId,DId,DCode,Sec,AmtOfPayment,DtOfPayment,RateOfTDS,TaxAmt,Surcharge,ECess,TotalTaxDeposited,TotalTaxDeducted,DtOfDeduction,Remark,ChallanID,IsBookEntry,CertNo) Values(" _
                & .ID26Q & ", " & IIf(.RetnID = 0, 0, .RetnID) & ", " _
                & IIf(.did = 0, 0, .did) & ", " _
...
Err:
    ...
    Public Function Delete(ByVal ID As Long) As Boolean
        ...
        sql = "Delete * From Deductee26Q Where Id26Q = " & ID
        cmd.Connection = cn
        transaction = cn.BeginTransaction()
        cmd.Transaction = transaction
    ...
    Public Function getChallanNo(ByVal ID As Long) As String
        ...
        nds = FetchDataSet("select BankChallanNo,DtOfChallan, TranVouNo from Challan26Q WHERE challanID=" & ID)
        If nds.Tables(0).Rows.Count > 0 Then
    ...
    Public Function GetChallanID(ByVal BChlNo As Long, ChlDt As Date) As Long
        ...
        nds = FetchDataSet("SELECT challanid FROM Challan26Q WHERE BankChallanNo=" & BChlNo & " and DtOfChallan=#" & Format(ChlDt, "MM/dd/yyyy") & "#")
        If nds.Tables(0).Rows.Count > 0 Then
